...
pub enum FrontendEvent {
    ...
    DirectChannelCreate(super::direct::FrontendDirectChannel),
    DirectChannelUpdate(super::direct::FrontendDirectChannel),
    DirectChannelDelete(super::direct::FrontendDirectChannelDelete),
